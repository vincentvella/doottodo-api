defmodule DootTodoWeb.Router do
  ...
  pipeline :api_authenticated do
    plug DootTodoWeb.AuthAccessPipeline
  end
  ...
  if Application.get_env(:doot_todo, :env) in [:dev, :test] do
    import Phoenix.LiveDashboard.Router

    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: DootTodoWeb.Telemetry, ecto_repos: [DootTodo.Repo]
    end
  end

  ## Authentication routes

  scope "/admin", DootTodoWeb do
